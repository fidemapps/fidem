...
var Q = require('bluebird'),
    ...
    logger = require('../config/logger'), // TO REPLACE
    config = require('meanio').loadConfig(); // TO REPLACE

var childLogger = logger.child({fidem: 'servicesWithToken'});  // TO REPLACE WITH OPTIONS
